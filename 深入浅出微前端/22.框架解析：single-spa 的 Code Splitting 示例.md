# 22.框架解析：single-spa 的 Code Splitting 示例
...
> 温馨提示：示例源码可以从 micro-framework 的 [demo/code\_splitting](https://github.com/ziyi2/micro-framework/tree/demo/code_splitting) 分支获取。
