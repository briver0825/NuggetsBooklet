...
<table data-header-hidden><thead><tr><th></th><th></th></tr></thead><tbody><tr><td>源码</td><td>ESLint 修复后</td></tr><tr><td><pre><code>const foo ='foo';
let  bar='bar';

console.log(foo,bar)
</code></pre></td><td><pre><code>const foo = 'foo'
const bar = 'bar'

console.log(foo, bar)
</code></pre></td></tr><tr><td><p>ESLint 配置：</p><pre><code>module.exports = {
    "extends": "standard"
}
</code></pre></td><td></td></tr><tr><td>ESLint 报错：<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c8f12f682beb4d9288eeb7c3cf107835~tplv-k3u1fbpfcp-zoom-1.image" alt=""></td><td></td></tr></tbody></table>
...
<table data-header-hidden><thead><tr><th></th><th></th></tr></thead><tbody><tr><td><code>src/index.ts</code> 源码</td><td>编译结果</td></tr><tr><td><pre><code>const say = (statements: string) => {
...
/******/ })()
;
</code></pre></td></tr><tr><td><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/dd3bd994134743a9a30200da59b47606~tplv-k3u1fbpfcp-zoom-1.image" alt=""></td><td></td></tr></tbody></table>
