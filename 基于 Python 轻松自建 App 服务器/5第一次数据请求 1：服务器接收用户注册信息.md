...
![](https://user-gold-cdn.xitu.io/2018/4/26/1630193b94de9b25?w=457\&h=117\&f=png\&s=6776) 其中，`users_urls.py` 处理针对 `users` 相关的路由及调用类之间的路由，`users_views.py` 为真正的逻辑处理。在 `users_urls.py` 中输入如下代码：
